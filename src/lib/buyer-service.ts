      ...
      if (orders.length > 0) {
        return orders.map((o) => {
          ...
          return {
            ...
            sellerName: seller?.name || (o.sellerType === "FPO" ? "Odisha Farmers Producer Organization" : "Verified Farmer"),
            ...
            items: (o.items || []).map((i) => ({
              ...
              qualityGrade: i.qualityGrade || "Grade A",
            })),
            subtotal: o.subtotal,
            ...
            carrierVehicle: "OD-02-CD-5678 (Eicher Pro Reefer)",
            ...
            deliveryHub: o.deliveryAddress?.addressLine || "Bhubaneswar Food Processing Hub",
